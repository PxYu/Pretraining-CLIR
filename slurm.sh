...
# srun --label python train.py --exp_name long_qlm-rr --fp16 true --amp 2 --model_type mbert-long --model_path dumped/long_qlm-rr/2148590/huggingface-3 --batch_size 2 --qlm_mask_mode query --mlm_probability 0.30 --optimizer adam,lr=0.00001 --clip_grad_norm 5 --epoch_size 2000 --max_epoch 4 --accumulate_gradients 1 --lambda_qlm 1 --lambda_rr 1 --num_neg 1 --rr_steps enfr,enes,ende,fres,frde,esde --qlm_steps enfr,enes,ende,fres,frde,esde --max_pairs 100000 --master_port 12223

srun --label python train.py --exp_name long_qlm-rr --fp16 true --amp 2 --model_type mbert-long --model_path dumped/long_qlm-rr/2150176/huggingface-3 --batch_size 2 --qlm_mask_mode query --mlm_probability 0.30 --optimizer adam,lr=0.00001 --clip_grad_norm 5 --epoch_size 2000 --max_epoch 4 --accumulate_gradients 1 --lambda_qlm 1 --lambda_rr 1 --num_neg 1 --rr_steps enfr,enes,ende,fres,frde,esde --qlm_steps enfr,enes,ende,fres,frde,esde --max_pairs 100000 --master_port 12223
